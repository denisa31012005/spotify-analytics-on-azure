...
![Jinja first](../images/jinjaParamJoin.PNG)
...
print(query)
```
*An example of how the final output looks like* :

![Jinja query](../images/jinjaDynamicQuery.PNG)

*Validation step where it is confirmed that the dynamic SQL generated by the Jinja template is correct* :

![Jinja final](../images/jinjaFinal.PNG)
